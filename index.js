...
function addStudent() {
    ...
    //Inputs are required if any input is missed we are sending alert to the user.
    ...
    // Store the updated students data in a array.
...
function search() {
    ...
    // Loop through all table rows to find the search value
